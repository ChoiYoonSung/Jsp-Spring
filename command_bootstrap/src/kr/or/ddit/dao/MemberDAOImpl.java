...
public class MemberDAOImpl implements MemberDAO{
	...
	@Override
	public List<MemberVO> selectMemberList(SqlSession session, Criteria criteria) throws SQLException {
		int offset = criteria.getStartRowNum();
		int limit = criteria.getEndRowNum();
