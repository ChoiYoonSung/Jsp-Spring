										...
										<form action="delete" method="post">
											<div class="row row-10 mbn-20">
												...
												<div class="col-sm-4.5 col-9 mb-20">
													<input type="text" class="form-control" id="id" name="memId" value="" placeholder="Id" required="required">
												</div>
												<div class="col-sm-1.5 col-3 mb-20">
												...
												<div class="col-12 mt-10 mb-20">
													<input type="submit" id="dlBtn" class="button button-outline button-danger" value="Delete">
												</div>
											</div>
										</form>
									</div>
